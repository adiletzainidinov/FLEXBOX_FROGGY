...
const LilypadGreenColorAssist: React.FC = () => {
  return (
    <svg width="200px" height="100px" viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg">
...
export default LilypadGreenColorAssist;
